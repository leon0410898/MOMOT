...
def get_args_parser():
    ...
    parser.add_argument('--visibility_thresh', type=float, default=0.0)
    parser.add_argument('--losses', type=str, nargs='*')
    parser.add_argument('--iou_thresh', type=float, default=0.5)
    parser.add_argument('--miss_tolerance', type=float, default=3)
    parser.add_argument('--freeze_det', action='store_true')
    return parser
...
def main(args):
    ...
    if args.pretrained is not None:
        model_without_ddp = load_model(model_without_ddp, args.pretrained, freeze_det=args.freeze_det)
    ...
    writer = None
    if args.debug and utils.get_local_rank() == 0:
